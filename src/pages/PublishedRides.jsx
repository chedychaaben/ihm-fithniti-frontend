        ...
        <div className="flex flex-col justify-start items-start gap-2 w-full">
          <div className="flex flex-col sm:flex-row h-full w-full justify-center items-center">
            ...
            {data?.ridesCreated?.map(ride => 
              ...
              <Pencil className="cursor-pointer p-1 rounded-lg bg-primary text-primary-foreground" size={25}/>
              <Trash className="text-destructive cursor-pointer" onClick={()=> handleDelete(ride._id)} />
              </Fragment>
            )}
        </div>
